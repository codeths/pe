...
<div class="h-auto text-center sm:h-full sm:w-1/4">
	<div
		class="hidden h-1/4 flex-col justify-center gap-y-1 bg-[#c34614] p-2 text-2xl font-medium text-white sm:flex"
	>
		<h1>
			{prettyDate(time)}
		</h1>
	...
	<div class="flex flex-col items-center bg-[#1a2741] p-2 sm:h-3/4">
		...
		<p class="text-xl text-white">Showing locations for</p>
		<select
			class="my-1 block max-w-80 rounded-md border-transparent bg-gray-100 text-center text-wrap focus:border-gray-500 focus:bg-white focus:ring-0"
